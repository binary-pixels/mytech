...
export function ArchDiagram() {
  return (
    <div className="my-8 rounded-xl border border-slate-700 bg-slate-900/80 p-5 not-prose">
      ...
      <div className="flex flex-wrap items-stretch gap-3">
        ...
        <div className="rounded-lg border border-violet-400/30 bg-violet-400/5 p-4 flex flex-col gap-2 min-w-[160px]">
          ...
          <div className="rounded border border-slate-700 bg-slate-800 px-3 py-1.5 text-xs text-slate-300 font-mono">
            PluginHostLauncher
          </div>
          <div className="rounded border border-slate-700 bg-slate-800 px-3 py-1.5 text-xs text-slate-300 font-mono">
            PluginHostInterface
        ...
        <div className="flex flex-col items-center justify-center gap-1.5 px-1 min-w-[80px]">
          <div className="flex items-center gap-1 text-cyan-500 text-xs font-mono">
            <div className="h-px w-5 bg-cyan-500/60" />
            <span>launch</span>
            <span>▶</span>
          </div>
          <div className="flex items-center gap-1 text-emerald-500 text-xs font-mono">
            <span>◀</span>
            <span>IPC</span>
            <div className="h-px w-5 bg-emerald-500/60" />
            <span>▶</span>
          </div>
          <p className="text-[10px] text-slate-600 text-center leading-tight mt-1">
            shared mem
            <br />
            &lt; 2 ms
          </p>
        ...
        <div className="rounded-lg border border-cyan-400/30 bg-cyan-400/5 p-4 flex flex-col gap-2 min-w-[190px] flex-1">
          ...
          <div className="rounded border border-slate-700 bg-slate-800 px-3 py-1.5 text-xs text-slate-400 font-mono">
      ...
      <p className="text-xs text-slate-500 mt-4">
        ...
        <strong className="text-slate-300">separate process</strong> — your host
